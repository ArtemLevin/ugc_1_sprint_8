...
def create_tables(client: Client):
    ...
    # client.execute("""
    # CREATE TABLE IF NOT EXISTS events.event_base_disturbed ON CLUSTER company_cluster AS events.event_base
    # ENGINE = Distributed(company_cluster, events, events.event_base)
    # SETTINGS
    ...
    #
    # client.execute("""
    # CREATE TABLE IF NOT EXISTS events.events_video_quality_disturbed ON CLUSTER company_cluster AS events.events_video_quality
    # ENGINE = Distributed(company_cluster, events, events.events_video_quality)
    # SETTINGS
    #     fsync_after_insert=0,
    #     fsync_directories=0;
    # """)
    #
    # client.execute("""
    # CREATE TABLE IF NOT EXISTS events.video_watched_to_end_disturbed ON CLUSTER company_cluster AS events.video_watched_to_end
    # ENGINE = Distributed(company_cluster, events, events.video_watched_to_end)
    # SETTINGS
    #     fsync_after_insert=0,
    #     fsync_directories=0;
    # """)
    #
    # client.execute("""
    # CREATE TABLE IF NOT EXISTS events.search_filter_used_disturbed ON CLUSTER company_cluster AS events.search_filter_used
    # ENGINE = Distributed(company_cluster, events, events.search_filter_used)
    # SETTINGS
    #     fsync_after_insert=0,
    #     fsync_directories=0;
    # """)
    #
    # client.execute("""
    # CREATE TABLE IF NOT EXISTS events.page_view_disturbed ON CLUSTER company_cluster AS events.page_view
    # ENGINE = Distributed(company_cluster, events, events.page_view)
    # SETTINGS
    #     fsync_after_insert=0,
    #     fsync_directories=0;
    # """)
    #
    # client.execute("""
    # CREATE TABLE IF NOT EXISTS events.click_disturbed ON CLUSTER company_cluster AS events.click
    # ENGINE = Distributed(company_cluster, events, events.click)
    # SETTINGS
    #     fsync_after_insert=0,
    #     fsync_directories=0;
    # """)